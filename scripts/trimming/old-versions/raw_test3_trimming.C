...
void raw_test3_trimming(std::string config_file) {
   ...
   // Directory containing the files
    std::string input_dir = "/lustre24/expphy/volatile/halla/sbs/sbs-gen/GEN_REPLAYS/" + pass + "/TEST/try8/" + exp_name + "/rootfiles/";  // cache directory for Raw data
