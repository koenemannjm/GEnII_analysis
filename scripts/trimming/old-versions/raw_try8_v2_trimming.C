...
void raw_try8_v2_trimming(std::string config_file) {
   ...
   // Directory containing the files
    ...
    std::string output_filename = output_dir + "QE_" + pass + "_try8_data_" + exp_name + "_sbs100p_nucleon_np" + ".root";
	...
	// reading in the tree
	C->GetEntry(i);
	if (bb_tr_n_in>0 && sbs_hcal_e_in > 0.025 && abs(bb_tr_vz_in[0])<0.27){
